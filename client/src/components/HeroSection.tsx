...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-orange-50 via-white to-purple-50 overflow-hidden">
      <div className="max-w-[1450px] mx-auto px-6 lg:px-16 pt-12 pb-16 relative">
          ...
          >
            <div className="space-y-4">
              <h1 className="text-7xl lg:text-8xl font-black leading-[0.95] tracking-tight">
                <span className="text-gray-900"> Find the right</span>
                <br />
              ...
              <p className="text-xl text-gray-600 leading-relaxed max-w-xl font-medium">
                ...
                with expert-led programs designed for real-world success.
              </p>
            </div>

            {/* CTA */}
            <div className="flex gap-4 mb-10">
              <button className="bg-primary text-white text-[15px] font-semibold px-7 py-3 rounded-xl transition-all duration-200 border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px]">
                Find course
              </button>

              <button className="text-foreground bg-white border-2 border-black flex items-center gap-2 text-[15px] font-semibold px-5 py-3 rounded-xl transition-all duration-200 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] group">
                View our blog
            ...
            <div className="flex gap-5 flex-wrap">
              <div className="bg-white/90 backdrop-blur-sm border-2 border-black rounded-2xl px-6 py-3 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 transition-all">
                <div className="bg-primary text-white text-[9px] font-semibold px-6 py-0.5 rounded-full mb-1 inline-block border-2 border-black">
                  e-learning
                </div>
              ...
              <div className="bg-primary rounded-2xl px-8 py-3 border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 transition-all">
                <div className="bg-yellow-400 text-black text-[9px] font-semibold px-3 py-0.5 rounded-full mb-1 inline-block border border-black">
                  Online
                </div>
                <div className="text-[11px] text-white/90">courses</div>
              ...
              <div className="bg-yellow-400 rounded-2xl px-6 py-3 border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 transition-all">
                <div className="text-black text-[12px] font-bold">★★★★★ 5.0</div>
                <div className="text-[11px] text-[#424242] font-medium">
                  learner reviews
                </div>
